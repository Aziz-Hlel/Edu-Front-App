...
export const EditSchoolNumbers = () => {
    ...
    const [newLevelStat, setLevelStat] = useState<LevelStatType>({ nbr_classes: 0, nbr_st: 0, nbr_leaving: 0, nbr_comming: 0, });
    ...
    const current_nbr_elvs = nbr_elvs_inLevel(newLevelStat.nbr_st, newLevelStat.nbr_leaving, newLevelStat.nbr_comming);
    ...
    const send = () => {
        ...
        payload['lid'] = lid;
        // axios(url + "retrieve/editLevelStat/", payload).then(_ => {
        //     refetchLevelStat()
        ...
        const postLoadingFunc = async () => {
            ...
            await axios.post(url + "retrieve/editLevelStat/", payload).then(async (_) => {
                await refetchLevelStat()
                                ...
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">التلاميذ بـ30أوت</label>
                                            <input type="number" name="nbr_elvs" value={newLevelStat.nbr_st} onChange={handle_change}
                                        ...
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">عدد الفصول</label>
                                    ...
                                    <>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">عدد مغادرون</label>
                                        ...
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">عدد وافدون</label>
                                    ...
                                    <>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">الكثافة</label>
                                            <input disabled={true} value={nbr_kethefa}
                                                className="bg-gray-50 border text-right border-gray-300 text-gray-400 text-sm rounded-lg focus:outline-blue-600 focus:border-primary-600 block w-full p-2.5 " />
                                        </div>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 ">الزيادة/النقصان</label>
