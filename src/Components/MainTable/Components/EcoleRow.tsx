...
const EcoleRow = ({ sid, collapse }: { sid: number, collapse: boolean }) => {
    ...
    const tr_default_classname = twMerge(" transition-all bg-transparent h-0 text-sm 2xl:text-base", collapse && "bg-white")
    const default_classname = twMerge("shadow-lg shadow-transparent flex items-center justify-center  overflow-hidden transition-all text-center h-0 ", collapse && "2xl:h-16 h-12 ")
