...
const MainTable = () => {
    ...
    return (
        <>
            <div className={twMerge("bg-transparent  w-full   px-10 pl-0.5 ", getScroolBar())}>
                ...
                <div className="   flex justify-center">
                    <table className=" bg-transparent 2xl:w-9/12 w-9/12 transition-all border-collapse border-none  cursor-default " >
                        <thead>
                        ...
                        <tbody className=" ">
                            <tr className=" 2xl:h-20 h-10 sticky top-16 bg-transparent  z-50" ><td colSpan={tableHeads.length} /></tr>
                            {!Del1Data &&
                                <tr className=" h-40 ">
                            ...
                            <tr className=" h-10" />
                            {Del1Data && Object.entries(Del1Data).map(([id, name]) => (
